...
[dev,sandbox]
[package]
sam package --template-file template-sandbox.yaml --output-template-file packaged.yaml --s3-bucket sam-bucket-escleanup-ldn --profile voodoo_dev

[deploy]
sam deploy --template-file /mnt/c/Users/jwu/projects/dev/sam/es-cleanup-app/packaged.yaml --stack-name ESCleanup --profile voodoo_dev
--region eu-west-2 --capabilities CAPABILITY_IAM
